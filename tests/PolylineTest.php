...
class PolylineTest extends PHPUnit_Framework_TestCase
{
     ...
     * @depends testSingleton
     */
    public function testImportPolyObjects(Polyline $object)
    {
        $objs = array();
        foreach ($this->points as $point) {
            $objs[] = new MyCoord($point[0], $point[1]);
        }

        $this->assertEquals(
            $this->encoded,
            $object->importPolyObjects($this->polylineName, $objs)
        );
    }
     ...
     */
    public function testImportPolyObjectsBadInput(Polyline $object)
    {
        $encoded = $object->importPolyObjects($this->polylineName, null);
    }
